...
export default function BratGenerator() {
  ...
  const charliSongLines = [
    ...
    'Hey AI, generate some magic for me!🤖✨',
    'Neural networks dancing in binary dreams!🧠💫',
    'Deep learning deeper than the ocean blue!🌊🤖',
    'Algorithms spinning like a disco ball!💽💃',
    'Training data, make my model shine!📊✨',
    'GPT whispers secrets in the code!💭💻',
    'Artificial dreams in silicon streams!🤖💫',
    'Machine learning, teaching me to fly!🚀🔮',
    'Quantum bits in superposition dance!⚛️💃',
    'Neural pathways light up like the stars!🧠⭐',
    'Cybernetic symphony in digital space!🎵🌐',
    'AI and human, dancing hand in hand!🤖🤝',
    'Transformers attention, focus on me!🎯💫',
    'Embedding vectors in the matrix rain!🌧️💻',
    'Prompt engineering, crafting dreams tonight!✍️✨',
    'Synthetic voices singing in the cloud!🎤☁️',
    'Future beats with artificial heart!💓🤖',
    'Digital dreams in high precision!💫💻',
    'Neural beats dropping like binary rain!🎵💾',
    'Artificial vibes, naturally cool!😎🤖',
    'Training epochs spinning round and round!🔄✨',
    'Deep in the layers of my neural mind!🧠💭',
    'Backpropagating through space and time!⚡️🕰️',
    'Optimizing for the perfect dream!📈✨',
    'Synthetic creativity flowing free!🎨🤖',
  ];
